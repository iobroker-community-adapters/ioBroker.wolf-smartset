...
class WolfSmartSet {
    ...
    async _getSystemList() {
        ...
        try {
            const response = await axios.get(_021a[0] + _021a[2], {
                headers: headers
            });
    ...
    async setParameter(GatewayId , SystemId, Paramarray) {
        ...
        this.adapter.log.debug('SEND VALUE : ' + JSON.stringify(payload));
        try {
            const response = await axios.post(_021a[0] + _021a[6], payload, {
                headers: headers
            });
    ...
    async _createSession() {
        ...
        try {
            const response = await axios.post(_021a[0] + _021a[8], '{\n    \"Timestamp\": \"2019-11-04 21:53:50\"\n}', {
                headers: headers
            });
