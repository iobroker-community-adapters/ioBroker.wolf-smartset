...
class WolfSmartSet {
    ...
    async _getAuthToken() {
        ...
        if (typeof this.openIdClient === 'undefined') {
            this.adapter.log.warn(`OpenID initialization failed!`);
            return;
        }
        ...
        try {
            ...
            if (
                ...
                typeof loginPage.headers === 'undefined' ||
                typeof loginPage.headers['set-cookies'] === 'undefined'
            ) {
                return;
            }
            ...
            if (
                typeof responsePost === 'undefined' ||
                typeof responsePost.headers === 'undefined' ||
                typeof responsePost.headers['set-cookies'] === 'undefined'
            ) {
                return;
            }
