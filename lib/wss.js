...
const _API_STRING = {
    ...
    "PATH_TOKEN": 					"/portal/connect/token",
    "PATH_GET_SYSTEM_LIST_OLD":		"/portal/api/portal/GetSystemList",
    "PATH_GET_GUI_DESC_FOR_APP":	"/portal/api/portal/GetGuiDescriptionForAppGateway2?GatewayId=",
    "PARAM_SYSTEM_ID":				"&SystemId=",
    "PATH_GET_PARAM_VALS":			"/portal/api/portal/GetParameterValues",
    "PATH_WRITE_PARAM_VALS":		"/portal/api/portal/WriteParameterValues",
    ...
    "PATH_GET_GUI_DESC_FOR_GW":		"/portal/api/portal/GetGuiDescriptionForGateway?GatewayId=",
};
...
class WolfSmartSet {
    ...
    async getGUIDescription(gatewayid, id) {
        const headers = await this._generateHeader('');
        try {
            const response = await axios.get(_API_STRING["WEBSERVER"] + _API_STRING["PATH_GET_GUI_DESC_FOR_GW"] + gatewayid + _API_STRING["PARAM_SYSTEM_ID"] + id, {
